*=====================================================================*
* File        : load_input_from_Excel.gms
* Version     : v0.2.0
* Date        : 2025-05-04
* Author      : [Your Name or Team]
* Description : Loads structured input data from Excel into GAMS,
*               including sets, parameters, scenario files, and performs
*               input verification. Compatible with MGET_v0_2_0.gms.
*=====================================================================*
